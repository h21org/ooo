...
download_and_extract_backhaul() {
    ...
    case "$ARCH" in
        x86_64)
            DOWNLOAD_URL="https://raw.githubusercontent.com/h21org/ooo/main/backhaul_premium_linux_amd64.tar.gz"
            ;;
        arm64|aarch64)
            DOWNLOAD_URL="https://raw.githubusercontent.com/h21org/ooo/main/backhaul_premium_linux_arm64.tar.gz"
            ;;
        *)
